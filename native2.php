<?php  
/*
Template Name: Tyzerna & Webanalytics
*/
?>
<?php get_header(); ?>
...
<div class="slider-container-nat">
 ...
 <div class="slide8 slide8-native" data-show-image="true">      
        <img loading="lazy" class="prop-img" src="<?php the_sub_field('ikonka_sli_ssp'); ?>" alt="">
            <h3><a class="prop-h3"><?php the_sub_field('tekst_sli_prosp_ssp'); ?></a></h3>
...
?>
        ...
        <div class="col-md-m-2">
            ...
            <button data-form-name="etaps-worcs" class="btn-first masthev-b cta-b"><?php the_field('tekst_na_knopczi'); ?></button>
        </div>
</div></div></div>
<div class="vidhuki">
